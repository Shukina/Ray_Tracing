...
// vec3 Up;
// vec3 Side;
// // îòíîøåíèå ñòîðîí âûõîäíîãî èçîáðàæåíèÿ
// vec2 Scale;
//};
//struct SRay
//{
...
//bool Raytrace ( SRay ray, float start, float final, inout SIntersection intersect ) /*ÒÓÒ ÍÀÄÎ ÄÎÄÅËÀÒÜ ÌÀÒÅÐÈÀËÛ!*/
//{
//	int numTriangles = 10;
//	bool result = false;
//	float test = start;
...
//{	 SCamera camera;
//	 camera.Position = vec3(0.0, 0.0, -7.99);
...
//{
////** LIGHT **//
//light.Position = vec3(0.0, 2.0, -4.0f); //0 3 -8
///** MATERIALS **/
...
//materials[6].Color = vec3(0.0, 1.0, 0.0);
